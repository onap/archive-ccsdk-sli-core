...
public class SvcLogicExpressionFactory implements SvcLogicExpressionParser {

    private static final Logger LOG = LoggerFactory.getLogger(SvcLogicExpressionFactory.class);
