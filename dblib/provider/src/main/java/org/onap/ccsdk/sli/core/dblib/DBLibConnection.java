...
public class DBLibConnection implements Connection {
    ...
    public boolean writeData(String statement, List<String> arguments) throws SQLException {
    ...
    public CachedRowSet getData(String statement, List<String> arguments) throws SQLException {
        ArrayList<Object> newList = new ArrayList<>();
        if (arguments != null && !arguments.isEmpty()) {
            newList.addAll(arguments);
        }
