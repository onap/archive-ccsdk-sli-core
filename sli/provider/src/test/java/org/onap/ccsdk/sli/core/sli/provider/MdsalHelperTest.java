...
public class MdsalHelperTest extends TestCase {
	...
	public void testBuilder() throws Exception{
		//TestObjectBuilder b = new TestObjectBuilder();
		//List<IpAddress> v4list = new ArrayList<IpAddress>();
		//v4list.add(IpAddressBuilder.getDefaultInstance("11.11.11.12"));
		//b.setFloatingIpV4(v4list );
		Properties props = new Properties();
		props.setProperty("test-object.floating-ip-v4_length", "1");
		props.setProperty("test-object.floating-ip-v4[0]", "11.11.11.12");
		props.setProperty("test-object.floating-ip-v4_length", "1");
	...
	public void testBuilderV6() throws Exception{
		//TestObjectBuilder b = new TestObjectBuilder();
		//List<IpAddress> v4list = new ArrayList<IpAddress>();
		//v4list.add(IpAddressBuilder.getDefaultInstance("11.11.11.12"));
		//b.setFloatingIpV4(v4list );
		Properties props = new Properties();
		props.setProperty("test-object.floating-ip-v6_length", "1");
		props.setProperty("test-object.floating-ip-v6[0]", "cafe::8888");
		props.setProperty("test-object.floating-ip-v6_length", "1");
