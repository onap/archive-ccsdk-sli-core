...
import org.onap.ccsdk.sli.core.api.Constants;
...
public class SvcLogicContextImpl implements SvcLogicContext {
	...
	public SvcLogicContextImpl(Properties props)
	{
        ...
        if (props.containsKey(Constants.SERVICE_LOGIC_STATUS))
		{
            this.status = props.getProperty(Constants.SERVICE_LOGIC_STATUS);
		}
	...
	public Properties toProperties()
	{
		...
		if (status != null)
		{
            props.setProperty(Constants.SERVICE_LOGIC_STATUS, status);
		}
