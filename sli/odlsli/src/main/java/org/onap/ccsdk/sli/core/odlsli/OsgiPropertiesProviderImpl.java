 ...
 * </ol>
 */
public class OsgiPropertiesProviderImpl implements SvcLogicPropertiesProvider {

	private static final Logger log = LoggerFactory.getLogger(OsgiPropertiesProviderImpl.class);
	 ...
	 * files.
	 */
	public OsgiPropertiesProviderImpl() {
		...
		sliPropertiesFileResolvers.add(
				new JREFileResolver("Using property file (3) from JRE argument", OsgiPropertiesProviderImpl.class));
	 ...
	 * </ol>
	 */
	File determinePropertiesFile(final OsgiPropertiesProviderImpl resourceProvider) {
