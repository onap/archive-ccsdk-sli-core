    ...
    public static void main(String argv[]) {
        ...
        if ("load".equalsIgnoreCase(argv[0])) {
            if (argv.length == 3) {
                ...
                SvcLogicStore store = SvcLogicParserImpl.getStore(propfile);
                try {
                    SvcLogicParserImpl.load(xmlfile, store);
                } catch (Exception e) {
            ...
            switch (argv.length) {
                ...
                case 5:
                    ...
                    SvcLogicStore store = SvcLogicParserImpl.getStore(propfile);
                    SvcLogicParserImpl.print(argv[1], argv[2], argv[3], version, store);
                    break;
                default:
                    SvcLogicParserImpl.usage();
            }
            ...
            if (argv.length == 6) {
                SvcLogicStore store = SvcLogicParserImpl.getStore(argv[5]);
                SvcLogicParserImpl.getSource(argv[1], argv[2], argv[3], argv[4], store);
            } else {
                SvcLogicParserImpl.usage();
            }
            ...
            if (argv.length == 6) {
                SvcLogicStore store = SvcLogicParserImpl.getStore(argv[5]);
                SvcLogicParserImpl.activate(argv[1], argv[2], argv[3], argv[4], store);
            } else {
                SvcLogicParserImpl.usage();
            }
            ...
            if (argv.length == 3) {
                ...
                SvcLogicStore store = SvcLogicParserImpl.getStore(propfile);
                try {
                    SvcLogicParserImpl.validate(xmlfile, store);
                } catch (Exception e) {
            ...
            if (argv.length == 3) {
                SvcLogicLoader loader = new SvcLogicLoaderImpl(argv[2]);
                try {
