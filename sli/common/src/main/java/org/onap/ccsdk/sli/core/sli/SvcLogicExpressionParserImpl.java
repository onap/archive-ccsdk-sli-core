...
public class SvcLogicExpressionParserImpl implements SvcLogicExpressionParser {

    private static final Logger LOG = LoggerFactory.getLogger(SvcLogicExpressionParserImpl.class);
